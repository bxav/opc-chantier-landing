        ...
        <section className="py-16">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="prose prose-slate max-w-none">
              ...
              <h2>Article 5 - Utilisation du service</h2>
              ...
              <h2>Article 6 - Donnees utilisateur</h2>
              <p>
              ...
              <p>
                Pour plus d&apos;informations, consultez notre <a href="/politique-confidentialite" className="text-primary hover:underline">Politique de confidentialite</a>.
              </p>

              <h2>Article 7 - Intelligence artificielle</h2>
              <p>
              ...
              <h2>Article 8 - Propriete intellectuelle</h2>
              <p>
